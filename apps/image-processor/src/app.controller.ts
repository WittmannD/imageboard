...
export class AppController {
  ...
  public async imageFromConfig(data: ImageProcessingMessageDto): Promise<ImageProcessingResponse> {
    const outputs = await firstValueFrom(this.appService.processFromConfig(data.path));
